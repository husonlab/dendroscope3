...
public class Split implements Comparable, Comparator {
    final private BitSet A;
    final private BitSet B;
    private double weight;
    final private List<Double> weightList; // list of weights assigned to this split in different trees
    private double confidence; // confidence in this split?
    final private List<Integer> treeNumbers; // numbers of the trees that this split appears in
    ...
    public void copy(Split split) {
        ...
        treeNumbers.addAll(split.treeNumbers);
    }
    ...
    public void addTreeNumber(Integer t) {
        treeNumbers.add(t);
    }

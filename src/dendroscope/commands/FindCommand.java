/*
 *   FindCommand.java Copyright (C) 2020 Daniel H. Huson
 *
 ...
 */
public class FindCommand extends CommandBaseMultiViewer implements ICommand {
    /**
    ...
    public String getDescription() {
        return "Find all occurrences of a text";
    }
    ...
    public void apply(NexusStreamParser np) throws Exception {
        if (np.peekMatchIgnoreCase("find searchtext")) {
            np.matchIgnoreCase("find searchtext=");
            ...
            for (Iterator<TreeViewer> it = multiViewer.getTreeGrid().getSelectedOrAllIterator(); it.hasNext(); ) {
                ...
                searchManager.runFind(searchText, target, all, regex, wholewords, respectcase);
            }
        }
    }
    ...
    public String getSyntax() {
        return "find searchtext=<text> [target={nodes|edges}] [all={true|false}] [regex={true|false}] [wholewords={true|false}] [respectcase={true|false}];";
    }
